...
df_test = pd.DataFrame([brand, size, status, type]).T
df_test.columns = ['Brand', 'Size', 'Status', 'Type']
df_test['Brand'] = df_test['Brand'].map({'Nike': 1, 'adidas': 2, 'Carhartt': 3, 'The North Face': 4, 'Tommy Hilfiger': 5, 'Lacoste': 6, 'Stüssy': 7, 'Napapijri': 8, 'Ralph Lauren': 9, 'Dickies': 10, 'Jack & Jones': 11, "Levi's": 12, 'Burberry': 13})
df_test['Size'] = df_test['Size'].map({
